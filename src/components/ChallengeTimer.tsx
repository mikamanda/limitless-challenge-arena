    ...
    return (
      <Card className="bg-red-500/20 backdrop-blur-md border-red-400/30 max-w-md mx-auto">
        <CardContent className="text-center p-6">
          ...
          <h3 className="text-xl font-bold text-red-300 mb-2">EXPIRÉ</h3>
          <p className="text-red-200">Le challenge est terminé</p>
        </CardContent>
      </Card>
    );
  }
    ...
    <Card className="bg-gradient-to-r from-red-500/30 to-orange-500/30 backdrop-blur-md border-orange-400/30 max-w-md mx-auto animate-pulse">
      <CardContent className="text-center p-6">
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-bold text-orange-200">TEMPS RESTANT</h3>
        </div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-4">
          <div className="text-center">
            <div className="bg-white/20 rounded-lg p-3 backdrop-blur-sm">
              ...
              <div className="text-xs text-orange-200">JOURS</div>
            </div>
          </div>
          <div className="text-center">
            <div className="bg-white/20 rounded-lg p-3 backdrop-blur-sm">
              <div className="text-2xl font-bold text-white">{timeLeft.hours}</div>
              <div className="text-xs text-orange-200">HEURES</div>
            </div>
          </div>
          <div className="text-center">
            <div className="bg-white/20 rounded-lg p-3 backdrop-blur-sm">
